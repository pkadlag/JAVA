...
public class BankTest {
	...
	public void currentAccountNormalCheck() {
		...
		MMCurrentAccount mmCurrentAccount = (MMCurrentAccount) mmBankFactory
				.getNewCurrentAccount("Punam", 0, 1000);
		try {
			mmCurrentAccount.depoiste(5000);
	...
	public void savingsAccount() {
		...
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount) mmBankFactory
				.getNewSavingAccount("Akshay", 0, true);
		try {
			mmSavingsAccount.depoiste(10);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void savingsAccountNormal() {
		BankFactory mmBankFactory = new MMBankFactory();
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount) mmBankFactory
				.getNewSavingAccount("Ajay", 0, true);
		try {
			mmSavingsAccount.depoiste(10);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void savingsAccountExceeds() throws Exception {
		...
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount) mmBankFactory
				.getNewSavingAccount("Ajay", 0, true);
		try {
			mmSavingsAccount.depoiste(1000);
			mmSavingsAccount.withdraw(2000);
		} catch (Exception e) {
			// e.printStackTrace();
			RuntimeException insufficientFunds = new InsufficientFundException();
